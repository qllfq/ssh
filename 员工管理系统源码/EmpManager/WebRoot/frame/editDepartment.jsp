...
<head>
 ...
 <link rel="stylesheet" href="${ pageContext.request.contextPath}/style/editDepartment.css">
	...
	<header id="header-top" class="header-top">
        ...
        <div class="contain-2">
            <div class="contain-2-1">
                <h3>员工管理系统<span>></span>部门管理<span>></span>编辑部门</h3>
            </div>
            <div class="contain-2-2">
                <div class="contain-2-2-1">
                    <div class="contain-2-2-1-1">
                        ...
                        <tr>
                           <td><h3>部门名称:</h3></td> 
		  				   <td><h3><s:textfield name="dname" value="%{model.dname }"/></h3></td>
                        </tr>
                        <tr>
                            <td><h3>部门介绍:</h3></td>
                            <td><h3><s:textarea rows="5" cols="50" name="ddesc" value="%{model.ddesc }" /></h3></td> 
                        </tr>
                        </table>
                        </s:form>
                    </div>
